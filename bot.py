...
def load_sheet_stock(sheet_name):
    ...
    # v4 fix:
    # If PRODUCT NAME doesn't exist (e.g. BAPE header is blank,
    # TRAVIS header is "h"), column A is automatically the product name.
...
async def show_product(query, sheet_name, product_index, brand_page):
    ...
    # Personal-price button for every available size
